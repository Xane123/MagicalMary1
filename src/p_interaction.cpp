...
CCMD (kill)
{
	if (argv.argc() > 1)
	{
		...
		else if (!stricmp (argv[1], "self") || !stricmp (argv[1], "mary") || !stricmp (argv[1], "xane"))
		{
	...
	else
	{
		...
		Printf("Kill? Be more specific about what you want to kill.\nUse \"self\" if you want to lose a life.\n");
		return;
