...
static bool Cht_WantedLevelUp(cheatseq_t *);	//[XANE]Added GTA Vice City's wanted level cheats.
static bool Cht_WantedLevelDown(cheatseq_t *);
...
static bool Cht_WantedLevelUp(cheatseq_t *cheat)
{
