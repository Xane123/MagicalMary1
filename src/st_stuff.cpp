...
static BYTE CheatXane[] =		{ 's','t','a','t','x',255 };	//STATX is supposed to decrease your speed but increase your jump height.
...
static cheatseq_t DoomCheats[] =
{
	...
	{ CheatXane,			0, 0, 0, {CHT_XANE,0},	Cht_Generic },
...
bool ST_Responder (event_t *ev)
{
	...
	{
		static cheatseq_t *cheatlists[] = { DoomCheats };
		static int counts[] = { countof(DoomCheats) };
